        ...
        <div className="medical-card p-8 space-y-6 shadow-lg">
          ...
          <div className="space-y-2.5">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2.5 px-4 rounded-xl border border-blue-200 bg-[#1877F2] hover:bg-[#166fe5] text-white text-xs font-bold transition-all flex items-center justify-center space-x-2.5 shadow-2xs cursor-pointer"
            >
              {/* Facebook SVG Logo */}
